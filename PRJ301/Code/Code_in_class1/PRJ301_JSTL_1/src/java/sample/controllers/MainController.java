...
public class MainController extends HttpServlet {
   ...
   private static final String SELECT_TOP = "SelectTop3";
   private static final String SELECT_TOP_CONTROLLER = "SelectTop3Controller";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            else  if(SELECT_TOP.equals(action)) {
                url = SELECT_TOP_CONTROLLER;
            }
        }catch(Exception e){
